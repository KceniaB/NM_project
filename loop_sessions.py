...
for i,rec in df1.iterrows(): 
    ...
    # continue
        ...
        nph_sync_start = nph_sync[0] - 50  # Start time, 100 seconds before the first nph_sync value
        nph_sync_end = nph_sync[-1] + 50   # End time, 100 seconds after the last nph_sync value
