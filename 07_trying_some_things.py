...
df_trials["mouse"] = df_trials.subject

#%% #########################################################################################################
""" GET PHOTOMETRY DATA """ 


# nph_path = '/mnt/h0/kb/data/one/mainenlab/Subjects/ZFM-05245/2023-03-31/001/alf/Region3G/raw_photometry.pqt'
nph_path = f'/mnt/h0/kb/data/one/mainenlab/Subjects/{mouse}/{date}/001/alf/Region{region}G/raw_photometry.pqt'
...
preprocessing_method = 'calcium_jove2019'
psth_good = df_nph[preprocessing_method].values[psth_idx[:,(df_trials.feedbackType == 1)]]
psth_error = df_nph[preprocessing_method].values[psth_idx[:,(df_trials.feedbackType == -1)]]
...
fig.suptitle(f'{preprocessing_method} {EVENT}_{mouse}_{date}_{region}_{NM}_{eid}', y=1, fontsize=14)
plt.tight_layout()
plt.show()
